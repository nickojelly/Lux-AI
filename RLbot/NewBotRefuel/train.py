...
from stable_baselines3.common.utils import set_random_seed, get_schedule_fn, get_linear_fn
...
def get_command_line_arguments():
    ...
    parser.add_argument('--batch_size', help='batch_size', type=int, default=2048*100)  # 64
    parser.add_argument('--step_count', help='Total number of steps to train', type=int, default=200_000_000)
    ...
    parser.add_argument('--n_envs', help='Number of parallel environments to use in training', type=int, default=100)
...
def train(args):
    ...
    if args.path:
        ...
        model.lr_schedule = get_linear_fn(0.005, 0.0001, 0.25)
        #model.n_steps = 200_000_000
        ...
        model = PPO("MlpPolicy",
                    ...
                    learning_rate=get_linear_fn(0.02, 0.0001, 0.75),
                    gamma=args.gamma,
    ...
    if args.n_envs > 1:
        ...
        callbacks.append(
            EvalCallback(env_eval, best_model_save_path=f'./logs_{run_id}/',
                             ...
                             n_eval_episodes=50, # Run 30 games
